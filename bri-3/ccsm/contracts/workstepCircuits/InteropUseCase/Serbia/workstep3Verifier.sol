...
contract PlonkVerifier {
    ...
    uint256 constant Qmx  = 5721177196754092106538503390276267740892619390996680240437273510471655283121;
    uint256 constant Qmy  = 8183016929977089885580363977992538607200181510275652630986705268111070413114;
    uint256 constant Qlx  = 8746426688538399384047520010178824686267079609091694430032148016240520010673;
    uint256 constant Qly  = 20806907042257680363345177403946371324660834845181313809204311321189218912030;
    uint256 constant Qrx  = 15692252755286771698671785668452512037977621827031378893861645664754533781238;
    uint256 constant Qry  = 710913106931500056835572360149837510293573909803567628994352890939236007610;
    uint256 constant Qox  = 20922908133855371958990800716080853210970062228745341732315187358061151458469;
    uint256 constant Qoy  = 6187462147825627979791824549635691623810368599180215103267274565051616627161;
    uint256 constant Qcx  = 8916821155112810931476131474333309908582352379507459331173725567107061551446;
    uint256 constant Qcy  = 7718697786021270756776328867704585424190392700179725981332813878485583277866;
    uint256 constant S1x  = 12724869915769556162845341241246057524542678343291841911178823588071085790599;
    uint256 constant S1y  = 2214598497009720340411598502171488117219462421712462072286562511099821954593;
    uint256 constant S2x  = 14894682767943913149697304775301486943557445417134790028070905582431916509920;
    uint256 constant S2y  = 17354635736042419687344015213380226924356922208388156152481993090177890426782;
    uint256 constant S3x  = 3635673583604344186020104996403270336942718914737534930394747216033323728978;
    uint256 constant S3y  = 15207615679043591302638236518284615605527003317429243002886824840917974822031;
    uint256 constant k1   = 2;
    uint256 constant k2   = 3;
    uint256 constant X2x1 = 2015106462243564135427591252538059629006463657604632660672195423828781925824;
    uint256 constant X2x2 = 9483709559773984562806357515930798917409548742233920269937966752729053123400;
    uint256 constant X2y1 = 19891334169773739002926519571236663530745380061065958723476379275756705902344;
    uint256 constant X2y2 = 9245395108394030195974987153407136778780872054779156065287622250478597258646;
    ...
    uint16 constant lastMem = 9024;

    function verifyProof(uint256[24] calldata _proof, uint256[257] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 8736 ), calldataload(pA))
                mstore(add(mIn, 8768 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 8800 ), calldataload(pB))
                mstore(add(mIn, 8832 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 8864 ), calldataload(pC))
                mstore(add(mIn, 8896 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 8928), q) 
